...
# ============================================================
# DÉFINIR LES CHEMINS (Scripts est le dossier parent du projet)
# ============================================================
...
model_phase1_path = MODELS_DIR / 'model_phase1.h5'
model.save(str(model_phase1_path))
print(f"✓ Modèle Phase 1 sauvegardé : {model_phase1_path}")
...
model_final_path = MODELS_DIR / 'model_final.h5'
...
curves_path_results = RESULTS_DIR / 'training_curves.png'

plt.savefig(str(curves_path_results), dpi=100)
plt.show()

print(f"✓ Courbes sauvegardées : {curves_path_results}")

print("\n✅ Entraînement terminé !")
print(f"📁 Modèle Phase 1 : {model_phase1_path}")
print(f"📁 Modèle final : {model_final_path}")
print(f"📊 Courbes : {curves_path_results}")